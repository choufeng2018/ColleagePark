...
/**
 *  Created by usb on 2017/9/19.法律服务
 */

public class LegalServiceActivity extends BaseActivity implements NewsFragmentView {
    ...
    public void setRecycleView(){
        ...
        lRecyclerViewAdapter.setOnItemClickListener((view, position) -> {
            Intent intent=  new Intent(LegalServiceActivity.this,NewsDetailActivity.class);
