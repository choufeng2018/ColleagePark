...
public class EasySlidingTabRecord extends HorizontalScrollView {
    ...
    public EasySlidingTabRecord(Context context) {
        this(context, null);
    }

    public EasySlidingTabRecord(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context, attrs);
    }

    public EasySlidingTabRecord(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void addTabs() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                EasySlidingTabRecord.this.currentPosition = EasySlidingTabRecord.this.pager.getCurrentItem();
                scrollToChild(EasySlidingTabRecord.this.currentPosition, 0);
            }
        });
    }
    ...
    private void addTab(final int position, View tab) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                EasySlidingTabRecord.this.pager.setCurrentItem(position);
            }
        });
...
//        tab.setPadding(2, 0, 2, 0);
        ...
        if (this.defaultTabLayoutParams == null) {
            ...
            this.tabWidth = this.width / (this.tabCount > 4 ? 4: this.tabCount);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            EasySlidingTabRecord.this.currentPosition = position;
            EasySlidingTabRecord.this.currentPositionOffset = positionOffset;

            View view = EasySlidingTabRecord.this.tabsContainer.getChildAt(position);
            if (view == null) {
                return;
            }
            ...
            if (EasySlidingTabRecord.this.delegatePageListener != null) {
                EasySlidingTabRecord.this.delegatePageListener.onPageScrolled(position, positionOffset, positionOffsetPixels);
            }
        }
        ...
        public void onPageScrollStateChanged(int state) {
            if (state == ViewPager.SCROLL_STATE_IDLE) {
                scrollToChild(EasySlidingTabRecord.this.pager.getCurrentItem(), 0);
            }

            if (EasySlidingTabRecord.this.delegatePageListener != null) {
                EasySlidingTabRecord.this.delegatePageListener.onPageScrollStateChanged(state);
            }
        }

        @Override
        public void onPageSelected(int position) {
            EasySlidingTabRecord.this.selectedPosition = position;
            updateTabStyles();
            if (EasySlidingTabRecord.this.delegatePageListener != null) {
                EasySlidingTabRecord.this.delegatePageListener.onPageSelected(position);
            }
        }
