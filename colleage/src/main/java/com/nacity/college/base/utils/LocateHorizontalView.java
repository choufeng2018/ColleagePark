...
public class LocateHorizontalView extends RecyclerView {
    ...
    public LocateHorizontalView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LocateHorizontalView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    /**
     * 设置初始化时选中的位置,该方法必须在{@link LocateHorizontalView#setAdapter(Adapter) }之前调用
     *
    ...
    /**
     * 设置每次显示多少个item,该方法必须在{@link LocateHorizontalView#setAdapter(Adapter) }之前调用
     *
