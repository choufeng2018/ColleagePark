...
import com.nacity.college.property.fragment.PropertyComplaintFragment;
...
public class PropertyComplaintActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle(Constant.COMPLAINT);
        setTpi(Constant.PROPERTY_COMPLAINT_RECORD);
    }

    public void setTpi(String[] titles) {
        mFragments.add(new PropertyComplaintFragment());
