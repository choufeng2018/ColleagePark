...
import com.nacity.college.property.fragment.KeeperFragment;
...
public class KeeperActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTpi(Constant.KEEPER_TPI);
    }

    public void setTpi(String[] titles) {
        mFragments.add(new KeeperFragment());
        mFragments.add(new ServiceRecordFragment(""));
