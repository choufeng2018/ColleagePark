...
public class PropertyPraiseActivity extends BaseActivity {
    @BindView(R.id.tpi)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle(Constant.PRAISE);
        setTpi(Constant.PROPERTY_PRAISE_TPI);
    }

    public void setTpi(String[] titles) {
        mFragments.add(new PropertyPraiseFragment(1));
        mFragments.add(new PraiseRecordFragment(1));
