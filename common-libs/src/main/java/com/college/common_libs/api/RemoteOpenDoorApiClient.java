...
public class RemoteOpenDoorApiClient {
    ...
    private static class SingletonHolder {
        private static final RemoteOpenDoorApiClient INSTANCE = new RemoteOpenDoorApiClient();
    }

    public static RemoteOpenDoorApiClient getInstance() {
    ...
    public void init(Context context) {
        ...
        Interceptor headInterceptor = (chain) -> chain.proceed(chain.request().newBuilder()
                ...
                .build());
        OkHttpClient okHttpClient = new OkHttpClient.Builder().writeTimeout(15000, TimeUnit.MILLISECONDS)
        ...
        //测试
     String baseUrl = "http://llkmc.izhihuicheng.net:8889/cgi-bin/";
